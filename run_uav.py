...
api_command = f"python3 uav_api.py --uav_connection {args.uav_connection} --port {args.port} --sysid {args.sysid} --connection_type {args.connection_type} --protocol_name {args.protocol_name} --pos {args.pos}"
