...
for i in range(args.n):
    ...
    uav_command = f"python3 run_uav.py --simulated true --protocol true --sysid {sysid} --pos {args.pos_list[i]} --uav_connection {connection} --port {port} --protocol_name {args.protocol_names[i]} --collaborators {collaborators} &"
